...
from clash_of_odin.harness.providers import Provider, make_provider
from clash_of_odin.lessons import LessonStore
...
def run_match(
    ...
    *,
    ...
    if render:
        try:
            from clash_of_odin.renderer.tui import TUIRenderer
        except ImportError:
            tui = None
        else:
...
def main() -> int:
    ...
    p = argparse.ArgumentParser(description="Run one Clash of Odin match")
