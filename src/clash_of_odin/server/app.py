...
from clash_of_odin.server.auth import TokenRegistry
...
def build_mcp_server(app: App, *, name: str = "clash-server") -> FastMCP:
    ...
    from clash_of_odin.server.game_tools import (
        register_game_tools,
        start_game_for_room,
    )
    from clash_of_odin.server.lobby_tools import register_lobby_tools
